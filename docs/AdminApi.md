...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.AdminApi(api_client)
    username = 'username_example' # str | username of the user to whom a badge is to be added
    body = gitea_async.UserBadgeOption() # UserBadgeOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    key = gitea_async.CreateKeyOption() # CreateKeyOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repository = gitea_async.CreateRepoOption() # CreateRepoOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.AdminApi(api_client)
    body = gitea_async.CreateUserOption() # CreateUserOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditUserOption() # EditUserOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.RenameUserOption() # RenameUserOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Search users according filter conditions
        api_response = await api_instance.admin_search_users(source_id=source_id, login_name=login_name, page=page, limit=limit, sort=sort, order=order, q=q, visibility=visibility, is_active=is_active, is_admin=is_admin, is_restricted=is_restricted, is_2fa_enabled=is_2fa_enabled, is_prohibit_login=is_prohibit_login)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a global runner
        api_response = await api_instance.get_admin_runner(runner_id)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get all runners
        api_response = await api_instance.get_admin_runners(disabled=disabled)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all jobs
        api_response = await api_instance.list_admin_workflow_jobs(status=status, page=page, limit=limit)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all runs
        api_response = await api_instance.list_admin_workflow_runs(event=event, branch=branch, status=status, actor=actor, head_sha=head_sha, page=page, limit=limit)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a global runner
        api_response = await api_instance.update_admin_runner(runner_id, body=body)
