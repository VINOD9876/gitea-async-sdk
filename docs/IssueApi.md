...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.IssueApi(api_client)
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = gitea_async.IssueLabelsOption() # IssueLabelsOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = gitea_async.AddTimeOption() # AddTimeOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = gitea_async.CreateIssueCommentOption() # CreateIssueCommentOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateIssueOption() # CreateIssueOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.IssueMeta() # IssueMeta |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateMilestoneOption() # CreateMilestoneOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    content = gitea_async.EditReactionOption() # EditReactionOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | id of the comment to edit
    body = gitea_async.EditIssueCommentOption() # EditIssueCommentOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditIssueOption() # EditIssueOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditDeadlineOption() # EditDeadlineOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditMilestoneOption() # EditMilestoneOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the issue
    body = gitea_async.LockIssueOption() # LockIssueOption |  (optional)
