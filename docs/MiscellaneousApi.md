...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.MiscellaneousApi(api_client)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get default signing-key.pub
        api_response = await api_instance.get_signing_key_ssh()
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.MiscellaneousApi(api_client)
    body = gitea_async.MarkdownOption() # MarkdownOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.MiscellaneousApi(api_client)
    body = gitea_async.MarkupOption() # MarkupOption |  (optional)
