...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.OrganizationApi(api_client)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an org-level runner
        api_response = await api_instance.get_org_runner(org, runner_id)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get org-level runners
        api_response = await api_instance.get_org_runners(org, disabled=disabled)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.OrganizationApi(api_client)
    organization = gitea_async.CreateOrgOption() # CreateOrgOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.OrganizationApi(api_client)
    org = 'org_example' # str | name of the organization
    body = gitea_async.CreateLabelOption() # CreateLabelOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.OrganizationApi(api_client)
    org = 'org_example' # str | name of the organization
    body = gitea_async.CreateTeamOption() # CreateTeamOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete all repositories in an organization
        await api_instance.org_delete_repos(org)
    except Exception as e:
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditOrgOption() # EditOrgOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditLabelOption() # EditLabelOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditTeamOption() # EditTeamOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.RenameOrgOption() # RenameOrgOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update an org-level runner
        api_response = await api_instance.update_org_runner(org, runner_id, body=body)
