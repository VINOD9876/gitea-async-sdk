...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.PackageApi(api_client)
    ...
    try:
        # Delete a package
        await api_instance.delete_package(owner, type, name)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Delete a package version
        await api_instance.delete_package_version(owner, type, name, version)
    except Exception as e:
