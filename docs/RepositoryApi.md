...
from gitea_async.rest import ApiException
from pprint import pprint

# Defining the host is optional and defaults to /api/v1
# See configuration.py for a list of all supported configuration parameters.
configuration = gitea_async.Configuration(
    host = "/api/v1"
)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.RepositoryApi(api_client)
...
> RunDetails actions_dispatch_workflow(owner, repo, workflow_id, return_run_details=return_run_details, body=body)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreateActionWorkflowDispatch() # CreateActionWorkflowDispatch |  (optional)

    try:
        # Create a workflow dispatch event
        api_response = await api_instance.actions_dispatch_workflow(owner, repo, workflow_id, return_run_details=return_run_details, body=body)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.RepositoryApi(api_client)
    body = gitea_async.CreateRepoOption() # CreateRepoOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreateForkOption() # CreateForkOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreateVariableOption() # CreateVariableOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.GenerateRepoOption() # GenerateRepoOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a repo-level runner
        api_response = await api_instance.get_repo_runner(owner, repo, runner_id)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get repo-level runners
        api_response = await api_instance.get_repo_runners(owner, repo, disabled=disabled)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets a specific workflow run attempt
        api_response = await api_instance.get_workflow_run_attempt(owner, repo, run, attempt)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Lists all jobs for a workflow run attempt
        api_response = await api_instance.list_workflow_run_attempt_jobs(owner, repo, run, attempt, status=status, page=page, limit=limit)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.AddCollaboratorOption() # AddCollaboratorOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreatePushMirrorOption() # CreatePushMirrorOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.ApplyDiffPatchFileOptions() # ApplyDiffPatchFileOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.ChangeFilesOptions() # ChangeFilesOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateBranchRepoOption() # CreateBranchRepoOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateBranchProtectionOption() # CreateBranchProtectionOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreateFileOptions() # CreateFileOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateHookOption() # CreateHookOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateKeyOption() # CreateKeyOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreatePullRequestOption() # CreatePullRequestOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreatePullReviewOptions() # CreatePullReviewOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreatePullReviewCommentReplyOptions() # CreatePullReviewCommentReplyOptions | 

    try:
        # Reply to a pull request review comment
        api_response = await api_instance.repo_create_pull_review_comment_reply(owner, repo, index, id, body)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request
    body = gitea_async.PullReviewRequestOptions() # PullReviewRequestOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateReleaseOption() # CreateReleaseOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    sha = 'sha_example' # str | sha of the commit
    body = gitea_async.CreateStatusOption() # CreateStatusOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateTagOption() # CreateTagOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateTagProtectionOption() # CreateTagProtectionOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.CreateWikiPageOptions() # CreateWikiPageOptions |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.DeleteFileOptions() # DeleteFileOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = gitea_async.DismissPullReviewOptions() # DismissPullReviewOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditRepoOption() # EditRepoOption | Properties of a repo that you can edit (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    name = 'name_example' # str | name of protected branch
    body = gitea_async.EditBranchProtectionOption() # EditBranchProtectionOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 'id_example' # str | id of the hook to get
    body = gitea_async.EditGitHookOption() # EditGitHookOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditHookOption() # EditHookOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditPullRequestOption() # EditPullRequestOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditReleaseOption() # EditReleaseOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.EditAttachmentOptions() # EditAttachmentOptions |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    id = 56 # int | id of protected tag
    body = gitea_async.EditTagProtectionOption() # EditTagProtectionOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get an archive of a repository
        await api_instance.repo_get_archive(owner, repo, archive, path=path)
    except Exception as e:
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.GetFilesOptions() # GetFilesOptions | 
    ref = 'ref_example' # str | The name of the commit/branch/tag. Default to the repository’s default branch. (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    index = 56 # int | index of the pull request to merge
    body = gitea_async.MergePullRequestOption() # MergePullRequestOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.MergeUpstreamRequest() # MergeUpstreamRequest |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.RepositoryApi(api_client)
    body = gitea_async.MigrateRepoOptions() # MigrateRepoOptions |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.RenameBranchRepoOption() # RenameBranchRepoOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Resolve a pull request review comment
        await api_instance.repo_resolve_pull_review_comment(owner, repo, id)
    except Exception as e:
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    index = 56 # int | index of the pull request
    id = 56 # int | id of the review
    body = gitea_async.SubmitPullReviewOptions() # SubmitPullReviewOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo to transfer
    repo = 'repo_example' # str | name of the repo to transfer
    body = gitea_async.TransferRepoOption() # TransferRepoOption | Transfer Options
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Unresolve a pull request review comment
        await api_instance.repo_unresolve_pull_review_comment(owner, repo, id)
    except Exception as e:
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.UpdateRepoAvatarOption() # UpdateRepoAvatarOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    branch = 'branch_example' # str | name of the branch
    body = gitea_async.UpdateBranchRepoOption() # UpdateBranchRepoOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.UpdateBranchProtectionPriories() # UpdateBranchProtectionPriories |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.UpdateFileOptions() # UpdateFileOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    owner = 'owner_example' # str | owner of the repo
    repo = 'repo_example' # str | name of the repo
    body = gitea_async.RepoTopicOptions() # RepoTopicOptions |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Reruns all failed jobs in a workflow run
        await api_instance.rerun_failed_workflow_run(owner, repo, run)
    except Exception as e:
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Reruns a specific workflow job in a run
        api_response = await api_instance.rerun_workflow_job(owner, repo, run, job_id)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Reruns an entire workflow run
        api_response = await api_instance.rerun_workflow_run(owner, repo, run)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repo
    runner_id = 'runner_id_example' # str | id of the runner
    body = gitea_async.EditActionRunnerOption() # EditActionRunnerOption |  (optional)

    try:
        # Update a repo-level runner
        api_response = await api_instance.update_repo_runner(owner, repo, runner_id, body=body)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repository
    secretname = 'secretname_example' # str | name of the secret
    body = gitea_async.CreateOrUpdateSecretOption() # CreateOrUpdateSecretOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    repo = 'repo_example' # str | name of the repository
    variablename = 'variablename_example' # str | name of the variable
    body = gitea_async.UpdateVariableOption() # UpdateVariableOption |  (optional)
