...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    api_instance = gitea_async.UserApi(api_client)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get a user-level runner
        api_response = await api_instance.get_user_runner(runner_id)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get user-level runners
        api_response = await api_instance.get_user_runners(disabled=disabled)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get workflow jobs
        api_response = await api_instance.get_user_workflow_jobs(status=status, page=page, limit=limit)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Get workflow runs
        api_response = await api_instance.get_user_workflow_runs(event=event, branch=branch, status=status, actor=actor, head_sha=head_sha, page=page, limit=limit)
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    try:
        # Update a user-level runner
        api_response = await api_instance.update_user_runner(runner_id, body=body)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.UserSettingsOptions() # UserSettingsOptions |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.CreateEmailOption() # CreateEmailOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.CreateHookOption() # CreateHookOption | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.CreateOAuth2ApplicationOptions() # CreateOAuth2ApplicationOptions | 
...
async with gitea_async.ApiClient(configuration) as api_client:
    ...
    body = gitea_async.CreateAccessTokenOption() # CreateAccessTokenOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    form = gitea_async.CreateGPGKeyOption() # CreateGPGKeyOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.DeleteEmailOption() # DeleteEmailOption |  (optional)
...
async with gitea_async.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = gitea_async.UserApi(api_client)
    body = gitea_async.UpdateUserAvatarOption() # UpdateUserAvatarOption |  (optional)
