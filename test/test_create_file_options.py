    ...
    def make_instance(self, include_optional) -> CreateFileOptions:
        ...
        if include_optional:
            return CreateFileOptions(
                author = gitea_async.models.identity.Identity(
                    email = '', 
                    name = '', ),
                branch = '',
                committer = gitea_async.models.identity.Identity(
                    email = '', 
                    name = '', ),
                content = '',
                dates = gitea_async.models.commit_date_options.CommitDateOptions(
