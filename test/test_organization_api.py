...
from gitea_async.api.organization_api import OrganizationApi
...
class TestOrganizationApi(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_get_org_workflow_jobs(self) -> None:
    ...
    async def test_get_org_workflow_runs(self) -> None:
    ...
    async def test_org_delete_repos(self) -> None:
    ...
    async def test_update_org_runner(self) -> None:
